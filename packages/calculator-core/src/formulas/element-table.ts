...
> = {
  ...
  poison: {
    neutral: [100, 100, 100, 100],
    water: [150, 100, 100, 100],
    earth: [150, 100, 100, 100],
    fire: [150, 100, 100, 100],
    wind: [150, 100, 100, 100],
    poison: [0, 0, 0, 0],
    holy: [75, 100, 100, 75],
    dark: [75, 25, 0, 0],
    ghost: [75, 100, 100, 100],
    undead: [75, 25, 0, 0],
  },
  holy: {
    neutral: [100, 100, 100, 100],
    ...
    fire: [100, 100, 100, 75],
    wind: [100, 100, 100, 75],
    poison: [75, 150, 175, 200],
    holy: [0, 0, 0, 0],
    dark: [125, 150, 175, 200],
    ghost: [100, 100, 100, 100],
    undead: [125, 175, 200, 200],
  },
  dark: {
    neutral: [100, 100, 100, 100],
    water: [100, 100, 100, 75],
